 ...
 *     description: Obtiene todas las tareas del usuario autenticado, ordenadas por fecha de creación descendente
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     description: Actualiza una tarea existente. Solo el propietario puede actualizar.
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Elimina una tarea existente. Solo el propietario puede eliminar.
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: path
